    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px auto 28px">
      <tr>
        <td align="center" style="background:#f5b056;border-radius:10px">
          <a href="${pluginUrl}" target="_blank" style="display:inline-block;padding:14px 32px;font-size:15px;font-weight:600;color:#1a1a1a;text-decoration:none;letter-spacing:0.01em">Télécharger le plugin</a>
        </td>
      </tr>
    </table>
