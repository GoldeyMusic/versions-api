        ...
        <tr>
          <td align="center" style="padding:8px 40px 32px">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" style="background:#b8892a;border-radius:10px">
      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e0d8cc">
        <tr>
          <td align="center" style="padding:36px 32px 20px;background:#ffffff;border-bottom:1px solid #e0d8cc">
            <div style="font-size:32px;font-weight:800;letter-spacing:0.04em;color:#b8892a;margin-bottom:6px">VERSiONS</div>
...
function renderActiveHtml({ firstName, stats }) {
  ...
  const bestBlock = (typeof stats.bestScore === 'number')
    ? `
      <div style="margin:24px 0 8px;padding:18px 20px;background:#faf7f2;border:1px solid #e8e2d8;border-radius:12px">
        ...
        <div style="font-size:30px;font-weight:800;color:#b8892a;line-height:1.1">${stats.bestScore}<span style="font-size:16px;color:#999;font-weight:600">/100</span></div>
  ...
  const bodyHtml = `
    ...
    <div style="margin:24px 0 8px;padding:18px 20px;background:#faf7f2;border:1px solid #e8e2d8;border-left:4px solid #b8892a;border-radius:12px">
      <div style="font-size:11px;font-weight:600;letter-spacing:0.12em;color:#b8892a;text-transform:uppercase;margin-bottom:8px">Conseil du mois</div>
...
function renderInactiveHtml({ firstName, stats }) {
  ...
  const bodyHtml = `
    ...
    <div style="margin:16px 0 8px;padding:18px 20px;background:#faf7f2;border:1px solid #e8e2d8;border-left:4px solid #b8892a;border-radius:12px">
      <div style="font-size:11px;font-weight:600;letter-spacing:0.12em;color:#b8892a;text-transform:uppercase;margin-bottom:8px">Conseil du mois</div>
      <div style="font-size:14px;color:#1a1a1a;line-height:1.55">${escapeHtml(conseil)}</div>
    </div>
